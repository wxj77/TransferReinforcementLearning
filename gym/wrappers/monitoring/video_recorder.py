...
class VideoRecorder(object):
    ...
    def __init__(self, env, path=None, metadata=None, enabled=True, base_path=None, render_mode='rgb_array'):
...
#        render_mode = 'ansi' if self.ansi_mode else 'rgb_array'
        render_mode = 'ansi' if self.ansi_mode else self.render_mode
